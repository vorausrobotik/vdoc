import { IntegrationBaseT } from './IntegrationBase'
...
export type OramaIntegrationT = IntegrationBaseT<OramaIntegrationFields>

export default OramaIntegrationT
