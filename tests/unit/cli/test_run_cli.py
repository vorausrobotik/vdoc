...
def test_cli_warns_about_default_credentials(_: MagicMock, cli_runner: CliRunner) -> None:  # noqa: PT019
...
@patch("vdoc.cli.run.run_impl")
def test_cli_doesnt_warn_about_updated_credentials(_: MagicMock, cli_runner: CliRunner) -> None:  # noqa: PT019
    result = cli_runner.invoke(app=app, args=["run"])
    assert result.exit_code == 0
